...
## Support
Should you encounter any issues with your account or subscription, [submit a technical support ticket](https://azure.microsoft.com/en-us/support/options/).  Technical support for Azure is provided by Microsoft.

## [Return to the main 'readme'](./readme.md#create-an-azure-iot-central-cloud-application)
